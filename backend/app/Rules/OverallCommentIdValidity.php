...
class OverallCommentIdValidity implements Rule, DataAwareRule
{
    /**
    ...
    /**
     * The parent of the overall comment thread
     *
     * @var \App\Models\OverallComment
     */
    private $parent;

    /**
     * The overall comment being replied to
     *
     * @var \App\Models\OverallComment
     */
    private $reply_to;
    ...
    public function passes($attribute, $value)
    {
        ...
        $data = $this->data['input']['overall_comments']['create'][0];
        ...
        if ($parent_id_exists && $reply_to_id_exists) {
            if (
                ...
                try {
                    ...
                    $this->reply_to = OverallComment::where('id', $data['reply_to_id'])->firstOrFail();
