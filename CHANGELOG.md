...
* Add commenting for changes to submission status ([#1455](https://github.com/MESH-Research/CCR/issues/1455)) ([a7775c6](https://github.com/MESH-Research/CCR/commit/a7775c693b20cfe1e302d4ac3ddd72f96f7c5a4b)), closes [#1327](https://github.com/MESH-Research/CCR/issues/1327)
* **api:** Convert uploaded files to html content ([#1517](https://github.com/MESH-Research/CCR/issues/1517)) ([f5ddf5d](https://github.com/MESH-Research/CCR/commit/f5ddf5dfab8fbcbba1aefc3b8c55ffed3abbda84))
* Update style guide colors ([#1431](https://github.com/MESH-Research/CCR/issues/1431)) ([f7b47d0](https://github.com/MESH-Research/CCR/commit/f7b47d04407f2936628f3bd4263ebcbaa14a6ba6))
* Update Submission Details page with invitation form (cosmetic change only) ([#1487](https://github.com/MESH-Research/CCR/issues/1487)) ([fcaa333](https://github.com/MESH-Research/CCR/commit/fcaa3332482c52c633ac65debd2917e4dc638ef9)), closes [#1399](https://github.com/MESH-Research/CCR/issues/1399)
* Update user interface for submissions requested for resubmission ([#1420](https://github.com/MESH-Research/CCR/issues/1420)) ([642a133](https://github.com/MESH-Research/CCR/commit/642a133c144eb2a88eeff078cc06878cc09e5bcb)), closes [#1329](https://github.com/MESH-Research/CCR/issues/1329)


### Bug Fixes

* **api,deps:** bump doctrine/dbal from 3.4.3 to 3.4.4 in /backend ([#1405](https://github.com/MESH-Research/CCR/issues/1405)) ([d7a4c85](https://github.com/MESH-Research/CCR/commit/d7a4c85eb4d7f6aad135d20cfe3743bdb5a4a309))
* **api,deps:** bump doctrine/dbal from 3.4.4 to 3.4.5 in /backend ([#1473](https://github.com/MESH-Research/CCR/issues/1473)) ([d2ce157](https://github.com/MESH-Research/CCR/commit/d2ce157b885bf033220cd3c641cc7e39582fb040))
* **api,deps:** bump laravel/framework from 9.27.0 to 9.28.0 in /backend ([#1409](https://github.com/MESH-Research/CCR/issues/1409)) ([624809d](https://github.com/MESH-Research/CCR/commit/624809dd37c206c73e5c9652842a9810e0021a95))
* **api,deps:** bump laravel/framework from 9.28.0 to 9.29.0 in /backend ([#1421](https://github.com/MESH-Research/CCR/issues/1421)) ([e984d2c](https://github.com/MESH-Research/CCR/commit/e984d2c8acdaeba63a855720123ab8a5ccf16f69))
* **api,deps:** bump laravel/framework from 9.29.0 to 9.30.0 in /backend ([#1433](https://github.com/MESH-Research/CCR/issues/1433)) ([be783e7](https://github.com/MESH-Research/CCR/commit/be783e7ef120c6d3354f28eb4ae57d0ed57f2064))
* **api,deps:** bump laravel/framework from 9.30.0 to 9.30.1 in /backend ([#1435](https://github.com/MESH-Research/CCR/issues/1435)) ([80f2cc6](https://github.com/MESH-Research/CCR/commit/80f2cc6344e9920024307b841a30add9fc1cdcf5))
* **api,deps:** bump laravel/framework from 9.30.1 to 9.31.0 in /backend ([#1456](https://github.com/MESH-Research/CCR/issues/1456)) ([e787614](https://github.com/MESH-Research/CCR/commit/e7876141845e70115e330ce75d91a98dd29309b8))
* **api,deps:** bump laravel/framework from 9.31.0 to 9.32.0 in /backend ([#1488](https://github.com/MESH-Research/CCR/issues/1488)) ([5100e7d](https://github.com/MESH-Research/CCR/commit/5100e7dbd33774e23e14e35e2f320b22657b1da2))
* **api,deps:** bump laravel/framework from 9.32.0 to 9.33.0 in /backend ([#1503](https://github.com/MESH-Research/CCR/issues/1503)) ([97e42a3](https://github.com/MESH-Research/CCR/commit/97e42a3e05ab864470ccc7b8bbf70b84d0d04cb5))
* **api,deps:** bump laravel/scout from 9.4.10 to 9.4.11 in /backend ([#1489](https://github.com/MESH-Research/CCR/issues/1489)) ([c768abb](https://github.com/MESH-Research/CCR/commit/c768abb037b3d3da74290eda19960f225067cf75))
* **api,deps:** bump laravel/scout from 9.4.11 to 9.4.12 in /backend ([#1518](https://github.com/MESH-Research/CCR/issues/1518)) ([b183c85](https://github.com/MESH-Research/CCR/commit/b183c855a665b4e4c503956214600e46bceb7f4b))
* **api,deps:** bump nuwave/lighthouse from 5.58.2 to 5.60.0 in /backend ([#1411](https://github.com/MESH-Research/CCR/issues/1411)) ([57383d8](https://github.com/MESH-Research/CCR/commit/57383d8efefd76996fe71bf25df4e7729496e60b))
* **api,deps:** bump nuwave/lighthouse from 5.60.0 to 5.61.0 in /backend ([#1451](https://github.com/MESH-Research/CCR/issues/1451)) ([875598a](https://github.com/MESH-Research/CCR/commit/875598abac93bb0546ae78c0b5ef6d845afbf33d))
* **api,deps:** bump olssonm/l5-zxcvbn from 4.5 to 5.0 in /backend ([828e338](https://github.com/MESH-Research/CCR/commit/828e3389b72d7e66f711946f9cec4897744cdfc2))
* **api,deps:** bump spatie/laravel-settings in /backend ([#1413](https://github.com/MESH-Research/CCR/issues/1413)) ([c2c4bcc](https://github.com/MESH-Research/CCR/commit/c2c4bcc7f0e6f6394054861deca22a8a2da56c28))
* **api,deps:** bump spatie/laravel-settings in /backend ([#1490](https://github.com/MESH-Research/CCR/issues/1490)) ([ffd1852](https://github.com/MESH-Research/CCR/commit/ffd185250b989bf4c563b172bce936243f90c483))
* **api,deps:** bump teamtnt/laravel-scout-tntsearch-driver in /backend ([#1434](https://github.com/MESH-Research/CCR/issues/1434)) ([0070b55](https://github.com/MESH-Research/CCR/commit/0070b559f3fb1a211fe54a1358c6786abef6f163))
* **api,deps:** bump teamtnt/laravel-scout-tntsearch-driver in /backend ([#1468](https://github.com/MESH-Research/CCR/issues/1468)) ([91e7a5c](https://github.com/MESH-Research/CCR/commit/91e7a5c1eb9ac60cc087ded121e85fb53d2437a5))
* **app,deps:** bump @apollo/client from 3.6.9 to 3.7.0 in /client ([#1513](https://github.com/MESH-Research/CCR/issues/1513)) ([94425af](https://github.com/MESH-Research/CCR/commit/94425af07c663c55dea696108e00466b9d60a423))
* **app,deps:** bump @quasar/extras from 1.15.2 to 1.15.3 in /client ([#1419](https://github.com/MESH-Research/CCR/issues/1419)) ([36ebd1b](https://github.com/MESH-Research/CCR/commit/36ebd1beca359616bc6c78ba531ecddf317e3c1f))
* **app,deps:** bump @quasar/extras from 1.15.3 to 1.15.4 in /client ([#1502](https://github.com/MESH-Research/CCR/issues/1502)) ([a48694e](https://github.com/MESH-Research/CCR/commit/a48694ef3c5c252953e68fd9a9b13e39cdd7829c))
* **app,deps:** bump @tiptap/extension-highlight in /client ([#1426](https://github.com/MESH-Research/CCR/issues/1426)) ([f08fecc](https://github.com/MESH-Research/CCR/commit/f08feccc060d60e401c3151bae9d631e4bdf665c))
* **app,deps:** bump @tiptap/extension-highlight in /client ([#1443](https://github.com/MESH-Research/CCR/issues/1443)) ([1077bb6](https://github.com/MESH-Research/CCR/commit/1077bb6acd06b3ebe8f39811f61f352508a08a6c))
* **app,deps:** bump @tiptap/extension-highlight in /client ([#1459](https://github.com/MESH-Research/CCR/issues/1459)) ([7ef516b](https://github.com/MESH-Research/CCR/commit/7ef516ba89c2a04d867b85f9dcf48c44357bef81))
* **app,deps:** bump @tiptap/extension-highlight in /client ([#1475](https://github.com/MESH-Research/CCR/issues/1475)) ([2c4eb01](https://github.com/MESH-Research/CCR/commit/2c4eb010d5b4eee0d48826c2e50976efb10abf4d))
* **app,deps:** bump @tiptap/extension-highlight in /client ([#1507](https://github.com/MESH-Research/CCR/issues/1507)) ([3a5dee3](https://github.com/MESH-Research/CCR/commit/3a5dee3f073db62e0e632161502b4bcdb2c6132c))
* **app,deps:** bump @tiptap/extension-italic in /client ([#1457](https://github.com/MESH-Research/CCR/issues/1457)) ([b8d2f31](https://github.com/MESH-Research/CCR/commit/b8d2f31f12738fc5db60fd73d53eb4cc03be6c3e))
* **app,deps:** bump @tiptap/extension-italic in /client ([#1481](https://github.com/MESH-Research/CCR/issues/1481)) ([fde3974](https://github.com/MESH-Research/CCR/commit/fde39742719d21749892f3c989d7ae4eda202954))
* **app,deps:** bump @tiptap/extension-link in /client ([#1424](https://github.com/MESH-Research/CCR/issues/1424)) ([446d47b](https://github.com/MESH-Research/CCR/commit/446d47b261ee2b581c302e177feca4fb1260fdf8))
* **app,deps:** bump @tiptap/extension-link in /client ([#1448](https://github.com/MESH-Research/CCR/issues/1448)) ([c4631c1](https://github.com/MESH-Research/CCR/commit/c4631c17f269245ca1c534e1a01c952f6e98028b))
* **app,deps:** bump @tiptap/extension-link in /client ([#1458](https://github.com/MESH-Research/CCR/issues/1458)) ([6fe6195](https://github.com/MESH-Research/CCR/commit/6fe6195bdc3fe6c0ad34f1512c953cc283af79dc))
* **app,deps:** bump @tiptap/extension-link in /client ([#1482](https://github.com/MESH-Research/CCR/issues/1482)) ([39c1abf](https://github.com/MESH-Research/CCR/commit/39c1abfe88c0522750fc8e2b6b021031b50c7f3d))
* **app,deps:** bump @tiptap/extension-link in /client ([#1509](https://github.com/MESH-Research/CCR/issues/1509)) ([cb2f92d](https://github.com/MESH-Research/CCR/commit/cb2f92d6003ab529123a0d4434e6520d55ef4a3b))
* **app,deps:** bump @tiptap/extension-ordered-list in /client ([#1477](https://github.com/MESH-Research/CCR/issues/1477)) ([ce0bfa2](https://github.com/MESH-Research/CCR/commit/ce0bfa25c26da689fa5556ce4b1513e97d8abdae))
* **app,deps:** bump @tiptap/extension-placeholder in /client ([#1423](https://github.com/MESH-Research/CCR/issues/1423)) ([d9fc832](https://github.com/MESH-Research/CCR/commit/d9fc83250ec5829d2faa4de9baf25ab7515ce31e))
* **app,deps:** bump @tiptap/extension-placeholder in /client ([#1438](https://github.com/MESH-Research/CCR/issues/1438)) ([f0dfdaa](https://github.com/MESH-Research/CCR/commit/f0dfdaa5bf6a0a392a445ce5e359b5dae05fc74a))
* **app,deps:** bump @tiptap/extension-placeholder in /client ([#1464](https://github.com/MESH-Research/CCR/issues/1464)) ([8e5748f](https://github.com/MESH-Research/CCR/commit/8e5748fe360114a63eb45e3243e4fe83634eebd3))
* **app,deps:** bump @tiptap/extension-placeholder in /client ([#1500](https://github.com/MESH-Research/CCR/issues/1500)) ([5e684e8](https://github.com/MESH-Research/CCR/commit/5e684e8344b716892c72c9a3b78d6fa85896070f))
* **app,deps:** bump @tiptap/extension-placeholder in /client ([#1514](https://github.com/MESH-Research/CCR/issues/1514)) ([cb82539](https://github.com/MESH-Research/CCR/commit/cb82539582fc7946f234a6c6b848d5383654a20f))
* **app,deps:** bump @tiptap/starter-kit in /client ([#1407](https://github.com/MESH-Research/CCR/issues/1407)) ([0534b9c](https://github.com/MESH-Research/CCR/commit/0534b9c14a23bb497b5bf8cb5e6c08d3fa9e468e))
* **app,deps:** bump @tiptap/starter-kit in /client ([#1430](https://github.com/MESH-Research/CCR/issues/1430)) ([deace17](https://github.com/MESH-Research/CCR/commit/deace170e98bc57146bfacaabae2850cf6c706e4))
* **app,deps:** bump @tiptap/starter-kit in /client ([#1437](https://github.com/MESH-Research/CCR/issues/1437)) ([890b8d9](https://github.com/MESH-Research/CCR/commit/890b8d90b6c40e93046bdf833ab30375003ba017))
* **app,deps:** bump @tiptap/starter-kit in /client ([#1462](https://github.com/MESH-Research/CCR/issues/1462)) ([8afa0f7](https://github.com/MESH-Research/CCR/commit/8afa0f71f5b747a0db4bf3cba8b35c4062157c86))
* **app,deps:** bump @tiptap/starter-kit in /client ([#1505](https://github.com/MESH-Research/CCR/issues/1505)) ([f0d7dab](https://github.com/MESH-Research/CCR/commit/f0d7dabaddfa87775b5566b92ac27877206870ac))
* **app,deps:** bump @tiptap/vue-3 in /client ([#1406](https://github.com/MESH-Research/CCR/issues/1406)) ([54b88b9](https://github.com/MESH-Research/CCR/commit/54b88b9559e4a759edb67c8792d3d4fa5dffcdfd))
* **app,deps:** bump @tiptap/vue-3 in /client ([#1429](https://github.com/MESH-Research/CCR/issues/1429)) ([a93d50a](https://github.com/MESH-Research/CCR/commit/a93d50a3c99efe1c43affc2ceb0ac4efe2d91666))
* **app,deps:** bump @tiptap/vue-3 in /client ([#1441](https://github.com/MESH-Research/CCR/issues/1441)) ([c7998b8](https://github.com/MESH-Research/CCR/commit/c7998b8df9ed0ab17c200ade9da04eebe54315ce))
* **app,deps:** bump @tiptap/vue-3 in /client ([#1463](https://github.com/MESH-Research/CCR/issues/1463)) ([518d9f1](https://github.com/MESH-Research/CCR/commit/518d9f1d46401db4d8cf5bd65aa17774b5c0cca0))
* **app,deps:** bump @tiptap/vue-3 in /client ([#1478](https://github.com/MESH-Research/CCR/issues/1478)) ([65593e3](https://github.com/MESH-Research/CCR/commit/65593e3c383c6c94f99a3c9f766ccf04f47a1bd0))
* **app,deps:** bump @tiptap/vue-3 in /client ([#1511](https://github.com/MESH-Research/CCR/issues/1511)) ([01a391b](https://github.com/MESH-Research/CCR/commit/01a391b7323ea01ce6813e3bc229fd9ab4103165))
* **app,deps:** bump @vue/apollo-composable in /client ([#1524](https://github.com/MESH-Research/CCR/issues/1524)) ([f29ba5e](https://github.com/MESH-Research/CCR/commit/f29ba5e9885ab6df1c4dd978f68d228cc52d9ee8))
* **app,deps:** bump @vuelidate/core in /client ([#1483](https://github.com/MESH-Research/CCR/issues/1483)) ([cede421](https://github.com/MESH-Research/CCR/commit/cede4210a8057f0f9ac29beaec21c0d9cadaf781))
* **app,deps:** bump @vuelidate/validators in /client ([#1484](https://github.com/MESH-Research/CCR/issues/1484)) ([a49a52e](https://github.com/MESH-Research/CCR/commit/a49a52e4e148b35a5a7abcb1308604e72ff73a39))
* **app,deps:** bump @vueuse/core from 9.1.1 to 9.2.0 in /client ([#1408](https://github.com/MESH-Research/CCR/issues/1408)) ([74eddb7](https://github.com/MESH-Research/CCR/commit/74eddb768fff773d9d290bfb66f44d3ce1144510))
* **app,deps:** bump @vueuse/core from 9.2.0 to 9.3.0 in /client ([#1485](https://github.com/MESH-Research/CCR/issues/1485)) ([826a1de](https://github.com/MESH-Research/CCR/commit/826a1de4d988c9559e6cdfcf2a34883025276b77))
* **app,deps:** bump axios from 0.27.2 to 1.0.0 in /client ([#1525](https://github.com/MESH-Research/CCR/issues/1525)) ([31afe01](https://github.com/MESH-Research/CCR/commit/31afe0158261345c5cfdac09cfc79f42b7cfed57))
* **app,deps:** bump axios from 1.0.0 to 1.1.2 in /client ([#1532](https://github.com/MESH-Research/CCR/issues/1532)) ([53e2d88](https://github.com/MESH-Research/CCR/commit/53e2d88b82bd7366f84293b66b9d723766a13e86))
* **app,deps:** bump core-js from 3.25.0 to 3.25.1 in /client ([#1417](https://github.com/MESH-Research/CCR/issues/1417)) ([03415dd](https://github.com/MESH-Research/CCR/commit/03415dd97f9580e0870c7a5dbf8c9e3065debb70))
* **app,deps:** bump core-js from 3.25.1 to 3.25.2 in /client ([#1453](https://github.com/MESH-Research/CCR/issues/1453)) ([e4fc935](https://github.com/MESH-Research/CCR/commit/e4fc9351c11d04c034b749cd08620aaf9fd63fa2))
* **app,deps:** bump core-js from 3.25.2 to 3.25.3 in /client ([#1474](https://github.com/MESH-Research/CCR/issues/1474)) ([6542ad0](https://github.com/MESH-Research/CCR/commit/6542ad001ab0f714dc08154d927dc9bfb286271a))
* **app,deps:** bump core-js from 3.25.3 to 3.25.5 in /client ([#1522](https://github.com/MESH-Research/CCR/issues/1522)) ([9b1fe9f](https://github.com/MESH-Research/CCR/commit/9b1fe9f5d685ebc5d3df1ac40f43401136f5f474))
* **app,deps:** bump luxon from 3.0.3 to 3.0.4 in /client ([#1486](https://github.com/MESH-Research/CCR/issues/1486)) ([a6efc80](https://github.com/MESH-Research/CCR/commit/a6efc803d41d72f3a8dcb603c6c7e55061513815))
* **app,deps:** bump quasar from 2.7.7 to 2.8.2 in /client ([#1439](https://github.com/MESH-Research/CCR/issues/1439)) ([40de084](https://github.com/MESH-Research/CCR/commit/40de084d4182f8881ae9d9708778742d3a01fd6c))
* **app,deps:** bump quasar from 2.8.2 to 2.8.3 in /client ([#1454](https://github.com/MESH-Research/CCR/issues/1454)) ([bfd37d8](https://github.com/MESH-Research/CCR/commit/bfd37d8a4abb677b9b857a5b183acadca83bf6d7))
* **app,deps:** bump vue from 3.2.38 to 3.2.39 in /client ([#1415](https://github.com/MESH-Research/CCR/issues/1415)) ([abd3992](https://github.com/MESH-Research/CCR/commit/abd3992509d8444b45007f49434154c73da8b63b))
* **app,deps:** bump vue from 3.2.39 to 3.2.40 in /client ([#1491](https://github.com/MESH-Research/CCR/issues/1491)) ([ee5bbe6](https://github.com/MESH-Research/CCR/commit/ee5bbe621ec2b64c785ef646f54754ca26d6fe03))
* **client:** make version display less verbose with tooltip ([#1404](https://github.com/MESH-Research/CCR/issues/1404)) ([100f3e7](https://github.com/MESH-Research/CCR/commit/100f3e772bb0438c5f65d59daf5c1aad7b395861))
* **client:** update deep selectors in comment reply quotes (deprecation) ([#1402](https://github.com/MESH-Research/CCR/issues/1402)) ([0a339ef](https://github.com/MESH-Research/CCR/commit/0a339ef647760625f7a9378b7d577776ba5eae15))

## [0.18.0](https://github.com/MESH-Research/CCR/compare/v0.17.0...v0.18.0) (2022-09-02)


### Features

* Add Notifications for Submission Status Changes ([#1307](https://github.com/MESH-Research/CCR/issues/1307)) ([110ffde](https://github.com/MESH-Research/CCR/commit/110ffde4f995f1b80031604fe915c060637cc246)), closes [#1275](https://github.com/MESH-Research/CCR/issues/1275)
* Add submission status to the submission details page ([#1270](https://github.com/MESH-Research/CCR/issues/1270)) ([8c44f9c](https://github.com/MESH-Research/CCR/commit/8c44f9c4812a5ca22fe3ffd9d1f646ef8e6e544e)), closes [#1254](https://github.com/MESH-Research/CCR/issues/1254)
* Add validation for style criteria submitted with inline comments ([#1377](https://github.com/MESH-Research/CCR/issues/1377)) ([80e3bfe](https://github.com/MESH-Research/CCR/commit/80e3bfe819ec2eb6fe0478c1485cff6ec35216ab)), closes [#1158](https://github.com/MESH-Research/CCR/issues/1158)
* **api:** Add fields for logged in users role to publications and submissions ([#1202](https://github.com/MESH-Research/CCR/issues/1202)) ([0b5edee](https://github.com/MESH-Research/CCR/commit/0b5edee9ce95b1dde8d92064e8c10b52a4d908b2))
* **api:** update unique validation message to be parsable by the client ([ea9d2ef](https://github.com/MESH-Research/CCR/commit/ea9d2ef0cb7d7b6910a5071cf7fac89a884b37ef))
* **client:** Add Fitness for Review Interactive Elements to User Interface ([#1337](https://github.com/MESH-Research/CCR/issues/1337)) ([57327ed](https://github.com/MESH-Research/CCR/commit/57327ed3f1fe9b70ed2f932c34c5d4fa833b08c1)), closes [#754](https://github.com/MESH-Research/CCR/issues/754)
* **client:** add publication content field editing  ([#1230](https://github.com/MESH-Research/CCR/issues/1230)) ([ea9d2ef](https://github.com/MESH-Research/CCR/commit/ea9d2ef0cb7d7b6910a5071cf7fac89a884b37ef)), closes [#1118](https://github.com/MESH-Research/CCR/issues/1118)
* **client:** change application sidebar into header ([#1244](https://github.com/MESH-Research/CCR/issues/1244)) ([3378623](https://github.com/MESH-Research/CCR/commit/337862330a0d32c688030bff0acd479c935d0408))
* **client:** display version number in footer when available ([#1401](https://github.com/MESH-Research/CCR/issues/1401)) ([ee414f4](https://github.com/MESH-Research/CCR/commit/ee414f43cb28c62ca5beb7900694ec209ff6ba40))
* **client:** improve publication setup interface ([ea9d2ef](https://github.com/MESH-Research/CCR/commit/ea9d2ef0cb7d7b6910a5071cf7fac89a884b37ef))
* **client:** scroll to top of inline comments when scroll to top button is clicked ([#1232](https://github.com/MESH-Research/CCR/issues/1232)) ([2bb087e](https://github.com/MESH-Research/CCR/commit/2bb087e3629b2598fb5345a88bf78a53f19038d8)), closes [#1200](https://github.com/MESH-Research/CCR/issues/1200)
* **client:** separate application admin restricted pages in sidebar menu ([ea9d2ef](https://github.com/MESH-Research/CCR/commit/ea9d2ef0cb7d7b6910a5071cf7fac89a884b37ef))
* **client:** toggle highlights on the submission review page ([#1224](https://github.com/MESH-Research/CCR/issues/1224)) ([a28b7a6](https://github.com/MESH-Research/CCR/commit/a28b7a6ac128c66dd3ceb4219575029f79f81370)), closes [#1037](https://github.com/MESH-Research/CCR/issues/1037)
* Enable click interactions on inline comment highlights ([#1362](https://github.com/MESH-Research/CCR/issues/1362)) ([b419d45](https://github.com/MESH-Research/CCR/commit/b419d45fc1560c4bdafaf099d94f8204be8140af)), closes [#1233](https://github.com/MESH-Research/CCR/issues/1233)
* Enable submission status updating in API ([#1280](https://github.com/MESH-Research/CCR/issues/1280)) ([0cf53bf](https://github.com/MESH-Research/CCR/commit/0cf53bf86dab6e7c612d7b9da4b84593dcea7876)), closes [#1261](https://github.com/MESH-Research/CCR/issues/1261)
* Make overall commenting consistent with inline commenting ([#1235](https://github.com/MESH-Research/CCR/issues/1235)) ([71885d2](https://github.com/MESH-Research/CCR/commit/71885d289234748c3ed0c7ff535cdf8a4aab7293))
* Make scroll to top button functional ([cf34278](https://github.com/MESH-Research/CCR/commit/cf3427886772398d8d84bcd6a73872b2ea931534))
* Update user interface for rejected submissions  ([#1388](https://github.com/MESH-Research/CCR/issues/1388)) ([8ee5f6c](https://github.com/MESH-Research/CCR/commit/8ee5f6cfc828378020ca9bc16d84255a559be0fa)), closes [#1330](https://github.com/MESH-Research/CCR/issues/1330)


### Bug Fixes

* **api,deps:** bump doctrine/dbal from 3.3.7 to 3.4.0 in /backend ([#1343](https://github.com/MESH-Research/CCR/issues/1343)) ([ac07fc3](https://github.com/MESH-Research/CCR/commit/ac07fc313b058d994ce147d74c58c613de5c3c6f))
* **api,deps:** bump doctrine/dbal from 3.4.0 to 3.4.1 in /backend ([#1364](https://github.com/MESH-Research/CCR/issues/1364)) ([f11bbae](https://github.com/MESH-Research/CCR/commit/f11bbae60cb3305c6d1dd70c56d615d36229b194))
* **api,deps:** bump doctrine/dbal from 3.4.1 to 3.4.2 in /backend ([#1367](https://github.com/MESH-Research/CCR/issues/1367)) ([9a9cb82](https://github.com/MESH-Research/CCR/commit/9a9cb821b6e7df5926106be78baca5ebbb12bf25))
* **api,deps:** bump doctrine/dbal from 3.4.2 to 3.4.3 in /backend ([#1395](https://github.com/MESH-Research/CCR/issues/1395)) ([fd7fe49](https://github.com/MESH-Research/CCR/commit/fd7fe4988ecc0bcce0361e495adff543a451ba08))
* **api,deps:** bump guzzlehttp/guzzle from 7.4.4 to 7.4.5 in /backend ([#1218](https://github.com/MESH-Research/CCR/issues/1218)) ([a824f31](https://github.com/MESH-Research/CCR/commit/a824f31cc440d038761176de2cab92940845f884))
* **api,deps:** bump guzzlehttp/guzzle from 7.4.5 to 7.5.0 in /backend ([#1381](https://github.com/MESH-Research/CCR/issues/1381)) ([c624b2b](https://github.com/MESH-Research/CCR/commit/c624b2b3839f04defd2b316244a3714c7f91cd11))
* **api,deps:** bump laravel/framework from 9.17.0 to 9.18.0 in /backend ([#1221](https://github.com/MESH-Research/CCR/issues/1221)) ([ee819f8](https://github.com/MESH-Research/CCR/commit/ee819f892017004c3c4dec98f18c1c09c16daddd))
* **api,deps:** bump laravel/framework from 9.18.0 to 9.19.0 in /backend ([#1247](https://github.com/MESH-Research/CCR/issues/1247)) ([efa8e65](https://github.com/MESH-Research/CCR/commit/efa8e651ac45e28001bc9e8128773386046798c3))
* **api,deps:** bump laravel/framework from 9.19.0 to 9.20.0 in /backend ([#1277](https://github.com/MESH-Research/CCR/issues/1277)) ([4828327](https://github.com/MESH-Research/CCR/commit/482832714b4f42aac393c9c7b5d6a8f49759ae1c))
* **api,deps:** bump laravel/framework from 9.20.0 to 9.21.0 in /backend ([#1292](https://github.com/MESH-Research/CCR/issues/1292)) ([93d14eb](https://github.com/MESH-Research/CCR/commit/93d14ebd47a6b08e6c241a375a10d448bb1aaa8c))
* **api,deps:** bump laravel/framework from 9.21.0 to 9.21.2 in /backend ([#1294](https://github.com/MESH-Research/CCR/issues/1294)) ([441fb89](https://github.com/MESH-Research/CCR/commit/441fb89363b50ec7161a0a37e2a4f30d0671efe1))
* **api,deps:** bump laravel/framework from 9.21.2 to 9.21.4 in /backend ([#1298](https://github.com/MESH-Research/CCR/issues/1298)) ([c3c08ac](https://github.com/MESH-Research/CCR/commit/c3c08acc924aedcc04b01607d1923033068519f2))
* **api,deps:** bump laravel/framework from 9.21.4 to 9.21.6 in /backend ([#1300](https://github.com/MESH-Research/CCR/issues/1300)) ([64c9c3e](https://github.com/MESH-Research/CCR/commit/64c9c3e1dfea202cd37ae881fa732cf1522eadcd))
* **api,deps:** bump laravel/framework from 9.22.1 to 9.23.0 in /backend ([#1324](https://github.com/MESH-Research/CCR/issues/1324)) ([7ae5c9d](https://github.com/MESH-Research/CCR/commit/7ae5c9d89d7e3eb9c8379c655ff6e2e45c8e6fec))
* **api,deps:** bump laravel/framework from 9.24.0 to 9.25.1 in /backend ([#1363](https://github.com/MESH-Research/CCR/issues/1363)) ([fcf1ea0](https://github.com/MESH-Research/CCR/commit/fcf1ea014ee0246fd8dde814a51ba4fa574dfac2))
* **api,deps:** bump laravel/framework from 9.25.1 to 9.26.0 in /backend ([#1372](https://github.com/MESH-Research/CCR/issues/1372)) ([d30cc56](https://github.com/MESH-Research/CCR/commit/d30cc560b8fa345d51ba696e6ca8838f0a976d3b))
* **api,deps:** bump laravel/framework from 9.26.0 to 9.26.1 in /backend ([#1376](https://github.com/MESH-Research/CCR/issues/1376)) ([3490dbe](https://github.com/MESH-Research/CCR/commit/3490dbe93ec503f6fcecffa57c0a1de4fddb39a1))
* **api,deps:** bump laravel/framework from 9.26.1 to 9.27.0 in /backend ([#1389](https://github.com/MESH-Research/CCR/issues/1389)) ([0599c47](https://github.com/MESH-Research/CCR/commit/0599c4712d18564f94efe4515c87c3b0600cdbed))
* **api,deps:** bump laravel/sanctum from 3.0.0 to 3.0.1 in /backend ([#1339](https://github.com/MESH-Research/CCR/issues/1339)) ([f5274f6](https://github.com/MESH-Research/CCR/commit/f5274f6c516c91d4932750e5f4cac9f6901d7bf0))
* **api,deps:** bump laravel/scout from 9.4.5 to 9.4.10 in /backend ([#1322](https://github.com/MESH-Research/CCR/issues/1322)) ([8e90b99](https://github.com/MESH-Research/CCR/commit/8e90b996f8fa10c4c2f0980fcf1f899987ac2f6f))
* **api,deps:** bump laravel/tinker from 2.7.0 to 2.7.2 in /backend ([#1319](https://github.com/MESH-Research/CCR/issues/1319)) ([ab70437](https://github.com/MESH-Research/CCR/commit/ab704373d09cc28f2f3d11cd8f4a76190ebc3452))
* **api,deps:** bump mews/purifier from 3.3.7 to 3.3.8 in /backend ([#1318](https://github.com/MESH-Research/CCR/issues/1318)) ([1fc09d8](https://github.com/MESH-Research/CCR/commit/1fc09d82f03e7d6de5960d1c125d18f56d947089))
* **api,deps:** bump nuwave/lighthouse from 5.42.1 to 5.57.0 in /backend ([#1320](https://github.com/MESH-Research/CCR/issues/1320)) ([ba8d94a](https://github.com/MESH-Research/CCR/commit/ba8d94add451352478475ebef7a11733620779e8))
* **api,deps:** bump nuwave/lighthouse from 5.57.0 to 5.57.1 in /backend ([#1325](https://github.com/MESH-Research/CCR/issues/1325)) ([521123e](https://github.com/MESH-Research/CCR/commit/521123e2340310232954d4a3b5b012bb3abda4a6))
* **api,deps:** bump nuwave/lighthouse from 5.57.1 to 5.57.3 in /backend ([#1338](https://github.com/MESH-Research/CCR/issues/1338)) ([45a0a51](https://github.com/MESH-Research/CCR/commit/45a0a51ef8e0aed3b976cc3591bcc6fabbfa114a))
* **api,deps:** bump nuwave/lighthouse from 5.57.3 to 5.57.4 in /backend ([#1342](https://github.com/MESH-Research/CCR/issues/1342)) ([c65cae7](https://github.com/MESH-Research/CCR/commit/c65cae72ab72bd95cc72b71aaa5bccfee201887f))
* **api,deps:** bump nuwave/lighthouse from 5.57.4 to 5.57.5 in /backend ([#1348](https://github.com/MESH-Research/CCR/issues/1348)) ([e41f775](https://github.com/MESH-Research/CCR/commit/e41f775ab69bd1bf111bd4ce51d52874022ead7f))
* **api,deps:** bump nuwave/lighthouse from 5.57.5 to 5.58.1 in /backend ([056b040](https://github.com/MESH-Research/CCR/commit/056b040a73e45d25a58b848ee57d0a2093769484))
* **api,deps:** bump nuwave/lighthouse from 5.58.1 to 5.58.2 in /backend ([#1375](https://github.com/MESH-Research/CCR/issues/1375)) ([902248d](https://github.com/MESH-Research/CCR/commit/902248d4df7e670fa29799371dee6d487ac64c8a))
* **api,deps:** bump spatie/laravel-permission in /backend ([#1321](https://github.com/MESH-Research/CCR/issues/1321)) ([8726fff](https://github.com/MESH-Research/CCR/commit/8726fff330877bdf38d4868651af9e325f75a14f))
* **api,deps:** bump spatie/laravel-settings in /backend ([#1323](https://github.com/MESH-Research/CCR/issues/1323)) ([295ff1b](https://github.com/MESH-Research/CCR/commit/295ff1be51ee47e2c1b39ab770452a99490960a8))
* **api,deps:** bump spatie/laravel-settings in /backend ([#1352](https://github.com/MESH-Research/CCR/issues/1352)) ([b7c1896](https://github.com/MESH-Research/CCR/commit/b7c1896baee2ab33ce865cdcb0c41d377aa647ff))
* **api:** publication admins can edit their publications ([ea9d2ef](https://github.com/MESH-Research/CCR/commit/ea9d2ef0cb7d7b6910a5071cf7fac89a884b37ef))
* **app,deps:** bump @apollo/client from 3.6.8 to 3.6.9 in /client ([#1228](https://github.com/MESH-Research/CCR/issues/1228)) ([de4c7ef](https://github.com/MESH-Research/CCR/commit/de4c7ef297f3c96105ca386cacd82310da1f03f7))
* **app,deps:** bump @quasar/extras from 1.14.0 to 1.14.1 in /client ([#1223](https://github.com/MESH-Research/CCR/issues/1223)) ([1ad07f5](https://github.com/MESH-Research/CCR/commit/1ad07f566eadc32ee90de521c211c2010cc670b8))
* **app,deps:** bump @quasar/extras from 1.14.1 to 1.14.2 in /client ([#1252](https://github.com/MESH-Research/CCR/issues/1252)) ([4d89abb](https://github.com/MESH-Research/CCR/commit/4d89abb2f87866488927e273a95a6cf31d157c59))
* **app,deps:** bump @quasar/extras from 1.14.2 to 1.14.3 in /client ([#1278](https://github.com/MESH-Research/CCR/issues/1278)) ([131ace9](https://github.com/MESH-Research/CCR/commit/131ace9a4e507a4a1eb1c390b07e56703ea5d037))
* **app,deps:** bump @quasar/extras from 1.14.3 to 1.15.0 in /client ([#1301](https://github.com/MESH-Research/CCR/issues/1301)) ([7868446](https://github.com/MESH-Research/CCR/commit/7868446145c137cc87f67835a3867daaa6392b55))
* **app,deps:** bump @quasar/extras from 1.15.0 to 1.15.1 in /client ([#1326](https://github.com/MESH-Research/CCR/issues/1326)) ([4cd7de8](https://github.com/MESH-Research/CCR/commit/4cd7de89facdd9c1fa69a2a39bea3cba07cba874))
* **app,deps:** bump @quasar/extras from 1.15.1 to 1.15.2 in /client ([#1383](https://github.com/MESH-Research/CCR/issues/1383)) ([5b44c96](https://github.com/MESH-Research/CCR/commit/5b44c965c8cead48a5473683f3d647a6e35969fd))
* **app,deps:** bump @tiptap/extension-link in /client ([#1242](https://github.com/MESH-Research/CCR/issues/1242)) ([c21825e](https://github.com/MESH-Research/CCR/commit/c21825e895f43f959c6c4bda8c403d9a9b31def7))
* **app,deps:** bump @tiptap/extension-placeholder in /client ([#1238](https://github.com/MESH-Research/CCR/issues/1238)) ([ac04853](https://github.com/MESH-Research/CCR/commit/ac04853b061e45ee3084836aefb99fa09fea10d9))
* **app,deps:** bump @tiptap/starter-kit in /client ([#1243](https://github.com/MESH-Research/CCR/issues/1243)) ([d877f4c](https://github.com/MESH-Research/CCR/commit/d877f4cd1f7492afed0884c67103bb8422537785))
* **app,deps:** bump @tiptap/starter-kit in /client ([#1269](https://github.com/MESH-Research/CCR/issues/1269)) ([ba1b511](https://github.com/MESH-Research/CCR/commit/ba1b51199fdb2616993ad5f3127b0cd57c83cbdc))
* **app,deps:** bump @tiptap/vue-3 in /client ([#1240](https://github.com/MESH-Research/CCR/issues/1240)) ([73f6534](https://github.com/MESH-Research/CCR/commit/73f65344e2a3f84ea06b8c1b555714b83d5f254d))
* **app,deps:** bump @vue/apollo-composable in /client ([#1227](https://github.com/MESH-Research/CCR/issues/1227)) ([7ca917a](https://github.com/MESH-Research/CCR/commit/7ca917a7974c492c18073e81aa692a2aa4bf60ff))
* **app,deps:** bump @vue/apollo-composable in /client ([#1288](https://github.com/MESH-Research/CCR/issues/1288)) ([f9b7f8d](https://github.com/MESH-Research/CCR/commit/f9b7f8d8f9144ed3bf06f57e56ed3fb41a537581))
* **app,deps:** bump @vue/apollo-option in /client ([#1229](https://github.com/MESH-Research/CCR/issues/1229)) ([7af8f7b](https://github.com/MESH-Research/CCR/commit/7af8f7b27f4346c160ea246d9de2f5b0a52d9b53))
* **app,deps:** bump @vue/apollo-option in /client ([#1290](https://github.com/MESH-Research/CCR/issues/1290)) ([be877d6](https://github.com/MESH-Research/CCR/commit/be877d6712fbfae8a0d8a7d04adb9acb4af294fc))
* **app,deps:** bump @vue/apollo-option in /client ([#1291](https://github.com/MESH-Research/CCR/issues/1291)) ([868acae](https://github.com/MESH-Research/CCR/commit/868acaea1eeb1198961936696cc34d5d865974a4))
* **app,deps:** bump @vuelidate/core in /client ([#1236](https://github.com/MESH-Research/CCR/issues/1236)) ([000601d](https://github.com/MESH-Research/CCR/commit/000601d32dce8b1b3c2c96d7091228bfa8d6cc30))
* **app,deps:** bump @vuelidate/core in /client ([#1304](https://github.com/MESH-Research/CCR/issues/1304)) ([545bebe](https://github.com/MESH-Research/CCR/commit/545bebee0c3ad8ea4950cbb89575b69fc7da70d8))
* **app,deps:** bump @vuelidate/core in /client ([#1341](https://github.com/MESH-Research/CCR/issues/1341)) ([94ff7ab](https://github.com/MESH-Research/CCR/commit/94ff7ab619a232b6c04feeae3a27923ead02156d))
* **app,deps:** bump @vuelidate/validators in /client ([#1237](https://github.com/MESH-Research/CCR/issues/1237)) ([38cb878](https://github.com/MESH-Research/CCR/commit/38cb87820b8cbe407e9db991aa01d5ff0a21e0b9))
* **app,deps:** bump @vuelidate/validators in /client ([#1305](https://github.com/MESH-Research/CCR/issues/1305)) ([06624a5](https://github.com/MESH-Research/CCR/commit/06624a54ea7983bf32a4c9ed2f01765c2a90313a))
* **app,deps:** bump @vueuse/core from 9.1.0 to 9.1.1 in /client ([#1374](https://github.com/MESH-Research/CCR/issues/1374)) ([2b96408](https://github.com/MESH-Research/CCR/commit/2b964080540a3c67dd19f059a018344219d35e70))
* **app,deps:** bump core-js from 3.23.1 to 3.23.2 in /client ([#1219](https://github.com/MESH-Research/CCR/issues/1219)) ([819e571](https://github.com/MESH-Research/CCR/commit/819e5714796067f787977e39306b6dcd6ce34d65))
* **app,deps:** bump core-js from 3.23.2 to 3.23.3 in /client ([#1241](https://github.com/MESH-Research/CCR/issues/1241)) ([cc7cb4b](https://github.com/MESH-Research/CCR/commit/cc7cb4b161e2a42e3cd36f842e421140a76614ec))
* **app,deps:** bump core-js from 3.23.3 to 3.23.4 in /client ([#1273](https://github.com/MESH-Research/CCR/issues/1273)) ([65b33be](https://github.com/MESH-Research/CCR/commit/65b33beed61885537a8ca2060bb2753a18010cd0))
* **app,deps:** bump core-js from 3.23.4 to 3.23.5 in /client ([#1287](https://github.com/MESH-Research/CCR/issues/1287)) ([42e3359](https://github.com/MESH-Research/CCR/commit/42e3359e0d81416bcf9ad6e2a21674b37eb2da87))
* **app,deps:** bump core-js from 3.23.5 to 3.24.0 in /client ([#1303](https://github.com/MESH-Research/CCR/issues/1303)) ([139efeb](https://github.com/MESH-Research/CCR/commit/139efebad1ad7e3e383f60595b1b73195e21a750))
* **app,deps:** bump core-js from 3.24.0 to 3.24.1 in /client ([#1316](https://github.com/MESH-Research/CCR/issues/1316)) ([208ea2d](https://github.com/MESH-Research/CCR/commit/208ea2d01046ba94c923c73a18513ccb43dadd56))
* **app,deps:** bump core-js from 3.24.1 to 3.25.0 in /client ([#1378](https://github.com/MESH-Research/CCR/issues/1378)) ([47ff03e](https://github.com/MESH-Research/CCR/commit/47ff03e5efd4e35011a5778112c2f5ae46ea7e21))
* **app,deps:** bump graphql from 16.5.0 to 16.6.0 in /client ([#1365](https://github.com/MESH-Research/CCR/issues/1365)) ([248c95d](https://github.com/MESH-Research/CCR/commit/248c95d9bc65dc3912f858be82f0eaef86947639))
* **app,deps:** bump javascript-time-ago from 2.5.4 to 2.5.5 in /client ([#1249](https://github.com/MESH-Research/CCR/issues/1249)) ([edec6bc](https://github.com/MESH-Research/CCR/commit/edec6bce64adadb74aadbcc8e04c4d6953694448))
* **app,deps:** bump javascript-time-ago from 2.5.5 to 2.5.6 in /client ([#1265](https://github.com/MESH-Research/CCR/issues/1265)) ([5db72be](https://github.com/MESH-Research/CCR/commit/5db72be6743a4721773f976f9299dee50d53c4d2))
* **app,deps:** bump luxon from 2.4.0 to 3.0.1 in /client ([#1272](https://github.com/MESH-Research/CCR/issues/1272)) ([fe4f241](https://github.com/MESH-Research/CCR/commit/fe4f241103969d8223b3bea2bca0fafebe563e8f))
* **app,deps:** bump luxon from 3.0.1 to 3.0.3 in /client ([#1391](https://github.com/MESH-Research/CCR/issues/1391)) ([150604a](https://github.com/MESH-Research/CCR/commit/150604acf545b62f1a70155db81fd1667e36714f))
* **app,deps:** bump quasar from 2.7.3 to 2.7.4 in /client ([#1251](https://github.com/MESH-Research/CCR/issues/1251)) ([9b71a8b](https://github.com/MESH-Research/CCR/commit/9b71a8b45fb820dd7a2fe995fe06a8c24f55fdeb))
* **app,deps:** bump quasar from 2.7.4 to 2.7.5 in /client ([#1259](https://github.com/MESH-Research/CCR/issues/1259)) ([5aa414a](https://github.com/MESH-Research/CCR/commit/5aa414ab62bc1f6948b0e76ef419499a6a4da02b))
* **app,deps:** bump quasar from 2.7.5 to 2.7.7 in /client ([#1340](https://github.com/MESH-Research/CCR/issues/1340)) ([16cab5e](https://github.com/MESH-Research/CCR/commit/16cab5e14217f15823e00eb35ec84bece6d4bba1))
* **app,deps:** bump vue from 3.2.37 to 3.2.38 in /client ([#1392](https://github.com/MESH-Research/CCR/issues/1392)) ([f770cf9](https://github.com/MESH-Research/CCR/commit/f770cf961b3167d6123d45ddec4f1ec4986c7c34))
* **app,deps:** bump vue-i18n from 9.2.0 to 9.2.2 in /client ([#1344](https://github.com/MESH-Research/CCR/issues/1344)) ([a945516](https://github.com/MESH-Research/CCR/commit/a9455160112b59aff7672ce56f9371f0bfad96bc))
* **app,deps:** bump vue-i18n from 9.2.0-beta.40 to 9.2.0 in /client ([#1314](https://github.com/MESH-Research/CCR/issues/1314)) ([bb8a56e](https://github.com/MESH-Research/CCR/commit/bb8a56e735890f49479889da85238da2f54153f0))
* **app,deps:** bump vue-i18n in /client ([#1279](https://github.com/MESH-Research/CCR/issues/1279)) ([aebc9d5](https://github.com/MESH-Research/CCR/commit/aebc9d5fce16b4904a16ed95d78bbffe25b5c382))
* **app,deps:** bump vue-i18n in /client ([#1286](https://github.com/MESH-Research/CCR/issues/1286)) ([f8e01b2](https://github.com/MESH-Research/CCR/commit/f8e01b25e8b0f000823f58c368e5ea7534f88f93))
* **app,deps:** bump vue-i18n in /client ([#1293](https://github.com/MESH-Research/CCR/issues/1293)) ([36a784c](https://github.com/MESH-Research/CCR/commit/36a784c3047615bf5dda774964dcbf28a15b6f68))
* **app,deps:** bump vue-router from 4.0.16 to 4.1.0 in /client ([#1258](https://github.com/MESH-Research/CCR/issues/1258)) ([7f03e16](https://github.com/MESH-Research/CCR/commit/7f03e1689fe35006a8e48f7f65301e49835821c8))
* **app,deps:** bump vue-router from 4.1.0 to 4.1.1 in /client ([#1266](https://github.com/MESH-Research/CCR/issues/1266)) ([fb864e6](https://github.com/MESH-Research/CCR/commit/fb864e67c5b5c5c6b09b6de658b13f8202ae1c77))
* **app,deps:** bump vue-router from 4.1.1 to 4.1.2 in /client ([#1274](https://github.com/MESH-Research/CCR/issues/1274)) ([5848ee6](https://github.com/MESH-Research/CCR/commit/5848ee6068a12f599f63ccd4e08a78db2f2b18e2))
* **app,deps:** bump vue-router from 4.1.3 to 4.1.4 in /client ([#1371](https://github.com/MESH-Research/CCR/issues/1371)) ([fb78650](https://github.com/MESH-Research/CCR/commit/fb786509fae6f00104d5c13a5a7023539f977529))
* **app,deps:** bump vue-router from 4.1.4 to 4.1.5 in /client ([#1379](https://github.com/MESH-Research/CCR/issues/1379)) ([445b376](https://github.com/MESH-Research/CCR/commit/445b3762a4c7b42142ae4997ce4d0ecc4640434b))
* **client:** add missing pagination of publication results ([ea9d2ef](https://github.com/MESH-Research/CCR/commit/ea9d2ef0cb7d7b6910a5071cf7fac89a884b37ef))
* **client:** reset client on logout to clean up user data ([ea9d2ef](https://github.com/MESH-Research/CCR/commit/ea9d2ef0cb7d7b6910a5071cf7fac89a884b37ef))
* Scrolling to reply references of replies ([#1245](https://github.com/MESH-Research/CCR/issues/1245)) ([a1c8155](https://github.com/MESH-Research/CCR/commit/a1c81554444e3a03801707125fe2b35007471a7d)), closes [#1199](https://github.com/MESH-Research/CCR/issues/1199)
* Update client for new expected input format ([#1397](https://github.com/MESH-Research/CCR/issues/1397)) ([b70e1ef](https://github.com/MESH-Research/CCR/commit/b70e1ef5246cc1635b1fc9fa4f8dd103fc452d3d))
