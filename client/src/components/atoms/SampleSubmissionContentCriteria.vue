<template>
  <h2>
    Various Material Design Icons Representing The Selected Style Criteria of
    Inline Comments
  </h2>
  <p>
    <span
  ...
  <section class="q-my-md q-gutter-md flex-column">
    <inline-comment-indicator-multiple-icons
      :icons="['accessibility', 'psychology']"
    ...
    />
    <inline-comment-indicator-multiple-icons
      :icons="['question_answer', 'close_fullscreen', 'psychology']"
  ...
  <section class="q-my-md q-gutter-md">
    <inline-comment-indicator-multiple-icons
      :icons="['close_fullscreen']"
...
<script setup>
import { ref } from "vue"
import InlineCommentIndicatorMultipleIcons from "./InlineCommentIndicatorMultipleIcons.vue"
