    ...
    const data = [
      {
        data: {
          ...
          notifiable_id: 1,
          data: `"{"submission":{"id":9999,"title":"A Modest Proposal"},"publication":{"id":9999,"name":"Test Publication from Tinker"},"user":{"id":9999,"username":"Test User from Tinker"},"type":"submission.accepted_for_review","body":"A submission status has been accepted for review.","action":"Visit CCR","url":"/"}"`,
