...
export type MetaControlsFragment = { __typename?: 'MetaForm', meta_prompts?: Array<{ __typename?: 'MetaPrompt', id: string, type: MetaPromptType, label: string, options?: any | null }> | null } & { ' $fragmentName'?: 'MetaControlsFragment' };
