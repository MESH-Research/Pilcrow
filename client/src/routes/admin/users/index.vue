...
definePage({
  // The "Users" crumb and the dashboard `navigation` entry live on the
  // parent layout (../users.vue) so the detail page nests under the same
  // section. This index just owns the list URL.
  name: "admin:users",
  meta: {}
})
